                ...
                <ul class="cart-product-item">
                    ...
                    <li>
                        ...
                        <a href="#" class="product-image">
                            <img src="img/product-img/product_125470001.jpg" alt="" />
                        </a>
                    ...
                    <li>
                        <!--Item Image-->
                        <a href="#" class="product-image">
                            <img src="img/product-img/product_125470002.jpg" alt="" /></a>
        ...
        <div class="cart-widget-footer">
            <div class="cart-footer-inner">
                ...
                <div class="cart-action-buttons">
                    <a href="cart.html" class="view-cart btn btn-lg">View Cart</a>
                    <a href="checkout.html" class="checkout btn btn-lg btn-color">Checkout</a>
                </div>
                <!-- End Cart Buttons -->
